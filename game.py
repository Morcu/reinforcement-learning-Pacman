...
class GameStateData:
    ...
    def initialize( self, layout, numGhostAgents ):
        ...
        for isPacman, pos in layout.agentPositions:
            if not isPacman:
                if numGhosts == numGhostAgents: nocontinue # Max ghosts reached already
                else: numGhosts += 1
...
class Game:
	...
	from bustersAgents import QLearningAgent_100330657_100330670
...
#devuelve la accion que ha tomado
            self.unmute()
		...
		if(primera):
			...
			estadoSig = observation
	
			

			#Update
			#QLearningAgent_100330657_100330670.update(estado, cadena,estadoSig)
        ...
        for agentIndex, agent in enumerate(self.agents):
            if "final" in dir( agent ) :
                try:
                    ...
                    self.unmute()
                    return
#	QLearningAgent_100330657_100330670.writeQtable()
        self.display.finish()
